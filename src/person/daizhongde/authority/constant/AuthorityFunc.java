 ...
 *
 */
public class AuthorityFunc extends AbstractConstant {
	
//	static{ System.out.println(1111); }
...
//	static{ System.out.println(2222); }
...
//	private static String combobox_HQL_fromSQL = combobox_HQL.substring( combobox_HQL_fromIndex );
	...
	public Map<String, String> getC2back() {
		if(INIT.PRODUCTION_MODE)
		{
			return col2back;
		}
