...
/**
 * TAuthorityUser entity. @author MyEclipse Persistence Tools
 */

public class TAuthorityUser implements java.io.Serializable {
...
//	private Integer NDid;
	 ...
	 * 采用
	 * ${pojo.EMployeeNumber } 解决
	 * 问题根本原因现在不清楚
	 * **/
//	private transient String EMployeeNumber;
//	private transient Integer SUpervisorId;
...
//	private String roles;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TAuthorityUser other = (TAuthorityUser) obj;
		if (NUid == null) {
			if (other.NUid != null)
				return false;
