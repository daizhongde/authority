 ...
 * @date 2013-09-29
 */
public class TAuthorityLevelCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected TAuthorityLevel pojo;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(TAuthorityLevel pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public TAuthorityLevel getPojo() {
		return pojo;
	}
