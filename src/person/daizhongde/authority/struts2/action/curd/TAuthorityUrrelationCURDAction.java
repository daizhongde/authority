 ...
 * @date 2013-09-29
 */
public class TAuthorityUrrelationCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected TAuthorityUrrelation pojo;
	protected TAuthorityUrrelationService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(TAuthorityUrrelation pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public TAuthorityUrrelation getPojo() {
		return pojo;
	}
	public void setDataService(TAuthorityUrrelationService dataService) {
