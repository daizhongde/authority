 ...
 * @date 2013-09-29
 */
public class TAuthorityRmrelationCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected TAuthorityRmrelation pojo;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(TAuthorityRmrelation pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public TAuthorityRmrelation getPojo() {
		return pojo;
	}
