 ...
 * @date 2013-09-29
 */
public class TAuthorityRmrelationJEasyUIQUERYAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected TAuthorityRmrelationService dataService;
...
//		System.out.println("absConstant.getQuery_SQL():"+absConstant.getQuery_SQL());
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "TAuthorityRmrelation");
		AbstractConstant absConstant = new AuthorityRmrelation();
...
//		} else {
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "TAuthorityRmrelation");
...
//	}
	...
	public void setDataService(TAuthorityRmrelationService dataService) {
