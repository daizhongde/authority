package person.daizhongde.authority.struts2.action.exp;
 ...
 * 
 */
public class TAuthorityModuleEXPAction extends BaseAction  {
	/**
	 * 
	 */
...
//		TimestampFormat	: "",////or "YYYYMMDD","YYYY-MM-DD-HHNNSS"
	 ...
	 * 同步导出(以提交form的形式导出)
	 * 
	 * @see person.daizhongde.CommonEXPAction.struts2.action.exp.TAuthorityModuleEXPAction#ExportXLS()
	 * @throws Throwable 
	 * 
	 */
